...
$(document).ready(function () {
  ...
  const homeSliderDots = $(".home-slider .owl-dots");
  const homeSliderNav = $(".home-slider .owl-nav");

  // homeSliderDots.append(homeSliderNav);

  // get Owl Dots height
  const dotsHeight = homeSliderDots.outerHeight();
  homeSliderNav.css("height", dotsHeight + 110 + "px");
